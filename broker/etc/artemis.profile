...
ARTEMIS_HOME='/Users/fernandofurtado/Downloads/apache-artemis-2.6.4'
ARTEMIS_INSTANCE='/Users/fernandofurtado/projecs/caelum/fj36-jms/broker'
ARTEMIS_DATA_DIR='/Users/fernandofurtado/projecs/caelum/fj36-jms/broker/data'
ARTEMIS_ETC_DIR='/Users/fernandofurtado/projecs/caelum/fj36-jms/broker/etc'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/Users/fernandofurtado/projecs/caelum/fj36-jms/broker/'
ARTEMIS_INSTANCE_ETC_URI='file:/Users/fernandofurtado/projecs/caelum/fj36-jms/broker/etc/'
...
# Java Opts
JAVA_ARGS=" -XX:+PrintClassHistogram -XX:+UseG1GC -XX:+AggressiveOpts -Xms512M -Xmx2G -Dhawtio.realm=activemq  -Dhawtio.offline="true" -Dhawtio.role=amq -Dhawtio.rolePrincipalClasses=org.apache.activemq.artemis.spi.core.security.jaas.RolePrincipal -Djolokia.policyLocation=${ARTEMIS_INSTANCE_ETC_URI}jolokia-access.xml"
